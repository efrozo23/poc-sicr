		...
		from(Constants.ROUTE_CONSUME_SERVICE).routeId("ROUTE_CONSUME_SERVICE").streamCaching()
			...
			.process( x ->{
				 ...
				 sslContext.init(null, null, null);
			      SSLConnectionSocketFactory f = new SSLConnectionSocketFactory(sslContext, new String[] { "TLSv1", "TLSv1.1", "TLSv1.2" }, new String[] {"TLS_RSA_WITH_AES_256_CBC_SHA","TLS_RSA_WITH_AES_128_CBC_SHA","SSL_RSA_WITH_3DES_EDE_CBC_SHA"},
